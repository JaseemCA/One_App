...
class ServiceEntity extends Equatable {
    ...
    return ServiceEntity(
      ...
      json['token_confirm'] is String &&
          ...
          : json['token_confirm'] is String &&
                  (json['token_confirm'] == '0' ||
                      json['token_confirm'].toString().toLowerCase() == 'false')
              ? false
      ...
      json['name_is_required_for_walkin'] is String &&
              (json['name_is_required_for_walkin'] == '1' ||
                  json['name_is_required_for_walkin']
                          .toString()
                          .toLowerCase() ==
                      'true')
          ? true
      ...
      json['email_is_required_for_walkin'] is String &&
              (json['email_is_required_for_walkin'] == '1' ||
                  json['email_is_required_for_walkin']
                          .toString()
                          .toLowerCase() ==
                      'true')
          ? true
      ...
      json['name_is_required'] is String &&
          ...
          : json['name_is_required'] is String &&
                  (json['name_is_required'] == '0' ||
                      json['name_is_required'].toString().toLowerCase() ==
                          'false')
              ? false
              : json["name_is_required"] ?? false,
      json['ask_email'] is String &&
              (json['ask_email'] == '1' ||
                  json['ask_email'].toString().toLowerCase() == 'true')
          ? true
          : json['ask_email'] is String &&
                  (json['ask_email'] == '0' ||
                      json['ask_email'].toString().toLowerCase() == 'false')
              ? false
              : json["ask_email"] ?? false,
      json['email_is_required'] is String &&
              (json['email_is_required'] == '1' ||
                  json['email_is_required'].toString().toLowerCase() == 'true')
          ? true
          : json['email_is_required'] is String &&
                  (json['email_is_required'] == '0' ||
                      json['email_is_required'].toString().toLowerCase() ==
                          'false')
              ? false
              : json["email_is_required"] ?? false,
      json['service'] != null
          ? json['service']['appointment_details']
  ...
  static List<ServiceEntity> fromJsonList(List<dynamic> jsonList) {
    ...
    for (var item in jsonList) {
      ServiceEntity service = fromJson(item);
      list.add(service);
    }
    return list;
  }
