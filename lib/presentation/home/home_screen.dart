...
import 'package:oneappcounter/presentation/popUp/add_service.dart.dart';
import 'package:oneappcounter/presentation/popUp/customer_flow_details.dart';
import 'package:oneappcounter/presentation/popUp/customer_queue_details.dart';
import 'package:oneappcounter/presentation/popUp/lock_service.dart';
import 'package:oneappcounter/presentation/popUp/remars_popup.dart';
import 'package:oneappcounter/presentation/popUp/transfer_to_services.dart';
import 'package:oneappcounter/presentation/popUp/unlockservice.dart';
import 'package:oneappcounter/presentation/settings_page/settings_page.dart';
import 'package:oneappcounter/routes.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildGridScreen() {
    ...
    secondGridViewList.clear();
    secondGridViewList = GeneralDataService.todayCalledNoShow;
    String secondGridViewLabel = translate('No Show ');
    if (CounterSettingService.counterSettings?.showHoldedInNoShow == true) {
      secondGridViewList = [
        ...GeneralDataService.todayCalledNoShow,
        ...GeneralDataService.todayCalledHolded,
      ];
      secondGridViewLabel += translate('/  Holded ');
    }
    if (CounterSettingService.counterSettings?.showNotTransferredInNoShow ==
        true) {
      List<TokenModel> list = secondGridViewList;
      ...
      secondGridViewLabel += translate('/  Not Transferred');
    }
        ...
        Column(
          children: [
                                        ...
                                        builder: (_context) {
                                          return AlertDialog(
                                            title: Text(translate(
                                                'Alert (Not transferred!)')),
                                            content: Text(
                                                '${GeneralDataService.lastCalledToken!.tokenNumber} ${translate('Not transferred, Continue Calling?')}'),
                                            actions: [
                                              TextButton(
                                                onPressed: () {
                                                  Navigator.pop(context);
                                        ...
                                        builder: (context) {
                                          return AlertDialog(
                                            title: Text(translate(
                                                'Transfer is required !')),
                                            content: Text(
                                                '${GeneralDataService.lastCalledToken!.tokenNumber} ${translate('Not transferred')}'),
                                            actions: [
                                              TextButton(
                                                onPressed: () {
                                                  Navigator.pop(context);
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(10, 5, 5, 10),
              child: StatefulBuilder(
                  builder: (BuildContext context, StateSetter _tabsetState) {
                return Row(
                  children: [
                    Expanded(
                      child: Column(
                    ...
                    CounterSettingService.counterSettings?.hideServiceEditBtn ==
                            true
                        ? Container()
                        : const SizedBox(width: 5),
                    CounterSettingService.counterSettings?.hideServiceEditBtn ==
                        ...
                        : IconButton(
                            onPressed: () async {
                              await _editServiceAndCounterTabDetails(
                                  _tabsetState);
                            },
                            icon: const Icon(
                              Icons.edit_note,
  ...
  Future<void> _editServiceAndCounterTabDetails(
      StateSetter _tabsetState) async {
    UtilityService.showLoadingAlert(_context);
    await GeneralDataService.initServiceAndCounterData();
    Navigator.pop(_context);
    showDialog(
        ...
        }).then((value) => _tabsetState(
          () {},
        ));
  }

  Widget _buildNonGridScreen() {
    TokenModel? token = selectedToken ?? GeneralDataService.lastCalledToken;
    ...
    return Stack(
      children: [
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        CounterSettingService
                                    .counterSettings?.hideServiceEditBtn ==
                                true
                            ? Container()
                            : const SizedBox(width: 5),
                        CounterSettingService
                            ...
                            child: Padding(
                              ...
                              child: CustomElevatedButton(
                                onPressed: CounterSettingService.counterSettings
                                              ...
                                              builder: (context) {
                                                return AlertDialog(
                                                  title: Text(translate(
                                                      'Alert (Not transferred!)')),
                                                  content: Text(
                                                      '${token.tokenNumber} ${translate('Not transferred, Continue Calling?')}'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () {
                                                        Navigator.pop(context);
                                              ...
                                              builder: (context) {
                                                return AlertDialog(
                                                  title: Text(translate(
                                                      'Transfer is required !')),
                                                  content: Text(
                                                      '${token.tokenNumber} ${translate('Not transferred')}'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () {
                                                        Navigator.pop(context);
                                    ...
                                    : null,
                                child: Text(translate('CALL NEXT')),
                              ),
                            ),
                          )
                        ],
                                  ...
                                  ? CustomElevatedButton(
                                      onPressed: CounterSettingService
                                          ...
                                          : token?.isHold == true
                                              ...
                                              : null,
                                      child: token?.isHold == true
                                          ? Text(translate('UNHOLD TOKEN'))
                                          : Text(translate('HOLD TOKEN')),
                                    )
                                  : Container(),
                            ),
                          ),
                                      ...
                                      ((token?.queue != null &&
                                              ...
                                              (token?.queueppointment != null &&
                                                  token?.queueppointment[
                                                          'is_transferred'] ==
                                                      true))
                                          ? translate('Token Transferred To')
                                          : translate(
                                              'Select Service to transfer'),
                                      textAlign: TextAlign.center,
                                      style: const TextStyle(
            ...
            Expanded(
              child: SizedBox(
                child: LayoutBuilder(builder: (context, constraints) {
                  return Column(
                    children: token?.status == 'served'
                        ? _getTransferButtons(constraints)
                        : [],
                  );
                }),
              ),
        ...
        CounterSettingService.counterSettings?.enableGridView == true &&
                selectedToken != null
            ? Positioned(
                bottom: 10,
                right: 10,
    ...
    return Column(
      children: [
                    ...
                    ? () {
                        ...
                        showBottomSheet(
                            ...
                            builder: (context) {
                              return CustomerQueueDetails(
                                serviceDetails:
                                    token?.queue['queue_appointment_details'] ??
                                        [],
                                phone: token?.queue['phone'] != null
                                    ? '+${token?.queue['calling_code']} ${token?.queue['phone']}'
                                    : null,
            ...
            child: Stack(
              ...
              children: [
                token != null
                          ...
                          child: Stack(
                            children: [
                              ...
                              ((CounterSettingService.counterSettings
                                              ...
                                              true) &&
                                          (token.queue != null &&
                                              token.queue['remarks'] != null) ||
                                      (token.queueppointment != null &&
                                          token.queueppointment['remarks'] !=
                                              null))
                                  ? Positioned(
                                      top: 12,
                                      right: 9,
                    ...
                    : Container(),
                Text(
                  token?.tokenNumber ?? translate('NIL'),
                  style: const TextStyle(
                    fontSize: 45,
                    fontWeight: FontWeight.bold,
                    height: 1,
        ...
        Row(
          ...
          children: [
            CounterSettingService.counterSettings?.showPriority == true
                ? ((token?.queueId != null && token?.queue['priority'] == 1) ||
                        (token?.queueppointmentId != null &&
                            token?.queueppointment['priority'] == 1))
                    ? Text(
                        'H',
                    ...
                    : ((token?.queueId != null &&
                        ...
                        : ((token?.queueId != null &&
                                    token?.queue['priority'] == 2) ||
                                (token?.queueppointmentId != null &&
                                    token?.queueppointment['priority'] == 2))
                            ? Text(
                                'N',
                                style: TextStyle(
                                  color: Colors.blue.shade600,
                ...
                : Container(),
            SizedBox(
              width: CounterSettingService.counterSettings?.showPriority == true
                  ? 20
                  : 0,
            ),
            servedTime.isEmpty
                ? StreamBuilder(
                    stream: ClockService.lastStopWatchTimerController.stream,
                    builder: (context, value) {
                      return Text(
                        token != null && value.data is String
                            ? value.data as String
            ...
            Text(
              token != null ? translate(token.status.toTitleCase()) : '',
              style: TextStyle(
                color: token?.statusColor ?? Colors.white,
                fontSize: 18,
                fontWeight: FontWeight.bold,
  ...
  List<Widget> _getTransferButtons(BoxConstraints constraints) {
    List<int> selectedTransferServices = [];
    TokenModel? token = selectedToken ?? GeneralDataService.lastCalledToken;
        ...
        : OutlinedButton(
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                        onPressed: () async {
                                          ...
                                          isBuildPending = false;
                                          UtilityService.toast(context,
                                              translate('Somthing went wrong'));
                                        },
                                        child: Text(translate('Proceed')),
                                      ),
                                    ],
                                    title:
                                        Text(translate('Cancelling Transfer')),
                                    content: Text(
                                        translate('Undo Transfer Ticket?')),
                                  );
                                });
                          }
                        : () async {
            ...
            child: Text(
              (token?.queueId != null &&
                      ...
                      (token?.queueppointmentId != null &&
                          token?.queueppointment['is_transferred'] == true)
                  ? translate('Undo Transfer')
                  : translate('TRANSFER TO (Show All services)'),
              overflow: TextOverflow.ellipsis,
            ),
          );
    ...
    List transferServices =
        CounterSettingService.counterSettings?.transferServices != null
            ? (CounterSettingService.counterSettings?.transferServices as List)
                ...
                .toList()
            : [];
    Widget multiTrasnferButton = CounterSettingService
                .counterSettings?.multipleTransfer ==
            true
        ? OutlinedButton(
            style: OutlinedButton.styleFrom(
              backgroundColor: UtilityService.isDarkTheme
                  ? const Color.fromARGB(255, 48, 99, 82)
                  : const Color.fromARGB(255, 2, 42, 87),
                ...
                showDialog(
                    ...
                    builder: (context) {
                      ...
                      return AlertDialog(
                        ...
                        title: Text(translate('Select Priority')),
                      );
                    }).then((value) async {
                  if (value is String && value.isNotEmpty) {
                    UtilityService.showLoadingAlert(_context);
                    ...
                    Navigator.pop(_context);
                    if (response is bool && response) {
                      UtilityService.toast(_context, translate('Transferred'));
                      selectedToken = null;
                      BlocProvider.of<CallBloc>(_context)
                          .add((CallNextTokenEvent()));
                      isBuildPending = false;
                    ...
                    isBuildPending = false;
                    UtilityService.toast(
                        _context, translate('Something went wrong'));
                  }
                });
              } else {
                UtilityService.toast(_context, "select service");
        ...
        if (GeneralDataService.activeServices
          ...
          widget.add(
            Padding(
              padding: const EdgeInsets.all(4.0),
              child: ConstrainedBox(
                constraints: BoxConstraints.tightFor(width: 85.w, height: 45),
                child: StatefulBuilder(builder: (context, buttonState) {
                  return ElevatedButton(
                    style: CounterSettingService
                                .counterSettings?.multipleTransfer ==
                      ...
                      if (CounterSettingService
                        ...
                        showDialog(
                          ...
                          if (value is String && value.isNotEmpty) {
                            ...
                            if (response is bool && response) {
                              UtilityService.toast(
                                  _context, translate('Transferred'));
                              selectedToken = null;
                              BlocProvider.of<CallBloc>(_context)
                                  .add((CallNextTokenEvent()));
                              isBuildPending = false;
